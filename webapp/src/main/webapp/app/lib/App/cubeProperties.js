Ext.define("uab.geobi.CubeProperties", {
    constructor: function(config) {
        ...
        this.getLevelsMaxNumber = getLevelsMaxNumber;
        this.findLevelByUniqueName = findLevelByUniqueName;
        this.findDimensionByName = findDimensionByName;
        this.findDimensionByUniqueName = findDimensionByUniqueName;
        this.findMeasureByUniqueName = findMeasureByUniqueName;
        this.findMemberByName = findMemberByName;
        this.findMemberByUniqueName = findMemberByUniqueName;
        this.findMemberParent = findMemberParent;
        this.getMemberChildren = getMemberChildren;
        this.getColumns = getColumns;
        this.getHeaderGroupRows = getHeaderGroupRows;
        this.findLevelByNumber =findLevelByNumber;
        this.getMembersCountByLevel = getMembersCountByLevel;
        this.getMembersByLevel = getMembersByLevel;
    }
});

Ext.namespace('App');
App.cubeProperties = new uab.geobi.CubeProperties({cubeName: App.cube.name});