...
public abstract class ChartFactory {
     ...
     * the same key in <code>previousDataset</code>. ie if value1 > value2 then
     * the section will be in green (unless <code>greenForIncrease</code> is
     * <code>false</code>, in which case it would be <code>red</code>). Each
     ...
     *            the dataset for the last run, this will be used to compare
     *            each key in the dataset
    ...
    public static JFreeChart createPieChart(String title, PieDataset dataset,
        ...
        if (subTitle) {
            TextTitle subtitle = new TextTitle("Bright "
                    ...
                    + percentDiffForMaxScale + "%, Bright "
                    + (!greenForIncrease ? "red" : "green") + "=change >=+"
                    + percentDiffForMaxScale + "%", new Font("SansSerif",
                    Font.PLAIN, 10));
    ...
    public static JFreeChart createBarChart(String title,
        ...
        return createBarChart(title, categoryAxisLabel, valueAxisLabel,
    ...
    public static JFreeChart createStackedBarChart3D(String title,
            String categoryAxisLabel, String valueAxisLabel,
            CategoryDataset dataset) {
        return createStackedBarChart3D(title, categoryAxisLabel,
                valueAxisLabel, dataset, PlotOrientation.VERTICAL, true, true,
                false);
    }
     ...
     *            the dataset for the chart (<code>null</code> permitted).
     * @param orientation
     *            the orientation (horizontal or vertical) (<code>null</code>
     *            not permitted).
     * @param legend
     *            a flag specifying whether or not a legend is required.
     * @param tooltips
     ...
     *            the chart title (<code>null</code> permitted).
     * @param categoryAxisLabel
     *            a label for the category axis (<code>null</code> permitted).
     * @param valueAxisLabel
     *            a label for the value axis (<code>null</code> permitted).
     * @param dataset
     *            the dataset for the chart (<code>null</code> permitted).
